...
// Professor: Clark Sexton
// Project 9 - Robot Arm
// 4/21/2025
// This program creates a robot arm with a base, lower arm, middle arm, and upper arm.
// The arms can be rotated using sliders to control the angles of each arm.
...
var Base = 0;
var LowerArm = 1;
var MiddleArm = 2; // Add middle arm
var UpperArm = 3;

var theta = [0, 0, 0, 0]; // Add angle for middle arm
...
window.onload = function init() {
    ...
    document.getElementById("slider3").onchange = function(event) {
         theta[MiddleArm] = event.target.value; // Add slider for middle arm
    };
...
var render = function() {
    ...
    // Move to the left side for the arm
